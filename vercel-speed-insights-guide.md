...
## Other Frameworks (Generic JavaScript)
...
Speed Insights is available for both [static](https://docs.vercel.com/frameworks/astro#static-rendering) and [SSR](https://docs.vercel.com/frameworks/astro#server-side-rendering) Astro apps.
